...
const VueTailwindComponents = {
  "t-button": {
    ...
    props: {
      ...
      classes:
        "text-gray-900 px-4 py-1 rounded-xl border-2 text-sm border-transparent hover:bg-gray-0 hover:text-gray-600 hover:border-gray-400",
  ...
  "t-table": {
    ...
    props: {
      fixedClasses: {
        table: "w-full bg-white shadow rounded",
        thead: "bg-white",
        theadTr: "",
        theadTh: "px-3 py-2 font-medium text-xs text-slate-500 text-left border-b",
        tbody: "",
        tr: "bg-white",
      ...
      classes: {
        ...
        tr: "hover:bg-blue-100 hover:cursor-pointer hover:text-slate-800",
      },
    },
  },
};
